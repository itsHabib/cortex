...
### Elixir idioms + enforcement

`with` for the happy path; pattern-match in function heads, not `if`; pipelines; small modules.

*Enforce:* Credo — `Refactor.Nesting`, `CyclomaticComplexity`, `Refactor.UnlessWithElse`.
<!-- END eng-philo -->
